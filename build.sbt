...
libraryDependencies += "com.datastax.dse" % "dse-java-driver-query-builder" % "2.3.0"

libraryDependencies += "co.fs2" %% "fs2-core" % "2.1.0"

libraryDependencies += "com.storm-enroute" % "scalameter_2.12" % "0.19"

libraryDependencies += "eu.timepit" %% "refined" % "0.9.10"
libraryDependencies += "eu.timepit" %% "refined-scalacheck" % "0.9.10"
